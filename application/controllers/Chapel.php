...
/*
    Filename    : Chapel.php
    Location    : application/controllers/Chapel.php
    Purpose     : Chapel controller
...
class Chapel extends REST_Controller
{
    ...
    public function index_get()
    {
        ...
        $getAll = $this->selection_references_model->_get_all_chapel();
