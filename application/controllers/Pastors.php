...
class Pastors extends REST_Controller
{
    ...
    public function pastors_get()
    {
        // Find and return a single record for a particular pastors.
        $id = (int)$this->get('id');
        ...
        // Get the Pastors from the array, using the id as key for retrieval.
        // Usually a model is to be used for this.
        $pastors = $this->pastors_model->_get_by_id($id);
