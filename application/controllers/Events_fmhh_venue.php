...
/*
    Filename    : Events_fmhh_venue.php
...
class Events_fmhh_venue extends REST_Controller
{
    ...
    public function index_get()
    {
        ...
        $getAll = $this->events_fmhh_venue_model->_get_all();
    ...
    public function medium_get()
    {
        ...
        $getById = $this->events_fmhh_venue_model->_get_by_id($id);
    ...
    public function create_post()
    {
        ...
        if (in_array(null, $data, true)) {
            ...
            $this->events_fmhh_venue_model->_create($data);
    ...
    public function update_put()
    {
        ...
        if (in_array(null, $data, true)) {
            ...
            $this->events_fmhh_venue_model->_update($id, $data);
    ...
    public function hard_delete_delete()
    {
        ...
        if (empty($id)) {
            ...
            // Delete the resource
            $this->events_fmhh_venue_model->_hard_delete($id);
