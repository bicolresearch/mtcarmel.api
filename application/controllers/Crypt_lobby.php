...
/*
    Filename    : Crypt_lobby.php
    Location    : application/controllers/Crypt_lobby.php
    Purpose     : Crypt Lobby controller
    Created     : 08/06/2019 18:11:20 by Scarlet Witch
    Updated     : 
    Changes     : 
*/
...
class Crypt_lobby extends REST_Controller
{
    ...
    public function index_get()
    {
        ...
        $getAll = $this->crypt_lobby_model->_get_all();
    ...
    public function medium_get()
    {
        ...
        $getById = $this->crypt_lobby_model->_get_by_id($id);
    ...
    public function create_post()
    {
        ...
        if (in_array(null, $data, true)) {
            ...
            $this->crypt_lobby_model->_create($data);
    ...
    public function update_put()
    {
        ...
        if (in_array(null, $data, true)) {
            ...
            $this->crypt_lobby_model->_update($id, $data);
    ...
    public function hard_delete_delete()
    {
        ...
        if (empty($id)) {
            ...
            // Delete the resource
            $this->crypt_lobby_model->_hard_delete($id);
