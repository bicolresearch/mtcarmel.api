...
/*
    Filename    : Funeral_service.php
    Location    : application/controllers/Funeral_service.php
    Purpose     : Funeral service controller
    Created     : 08/06/2019 17:50:49 by Scarlet Witch
    Updated     : 
    Changes     : 
*/
...
class Funeral_service extends REST_Controller
{
    ...
    public function index_get()
    {
        ...
        $getAll = $this->funeral_service_model->_get_all();
    ...
    public function create_post()
    {
        $data = [
            ...
            'dt_death' => $this->post('dt_death'),
            'cause_of_death' => $this->post('cause_of_death'),
            'funeral_location' => $this->post('funeral_location'),
            'service' => $this->post('service'),
            'dt_of_service' => $this->post('dt_of_service'),
            'time_of_service' => $this->post('time_of_service'),
            'dt_internment' => $this->post('dt_internment'),
            'time_internment' => $this->post('time_internment'),
            'place_internment' => $this->post('place_internment'),
        ...
        if (in_array(null, $data, true)) {
            ...
            $this->funeral_service_model->_create($data);
    ...
    public function update_put()
    {
        $data = [
            'name' => $this->put('name'),
            'civil_status' => $this->put('civil_status'),
            'dt_birth' => $this->put('dt_birth'),
            'dt_death' => $this->put('dt_death'),
            'cause_of_death' => $this->put('cause_of_death'),
            'funeral_location' => $this->put('funeral_location'),
            'service' => $this->put('service'),
            'dt_of_service' => $this->put('dt_of_service'),
            'time_of_service' => $this->put('time_of_service'),
            'dt_internment' => $this->put('dt_internment'),
            'time_internment' => $this->put('time_internment'),
            'place_internment' => $this->put('place_internment'),
        ...
        if (in_array(null, $data, true)) {
            ...
            $this->funeral_service_model->_update($id, $data);
    ...
    public function hard_delete_delete()
    {
        ...
        if (empty($id)) {
            ...
            // Delete the resource
            $this->funeral_service_model->_hard_delete($id);
