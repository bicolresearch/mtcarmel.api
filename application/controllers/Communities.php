...
/*
    Filename    : Communities.php
    Location    : application/controllers/Communities.php
    Purpose     : Communities baptism controller
    Created     : 08/07/2019 12:38:27 by Scarlet Witch
    Updated     : 10/30/2019 12:13:06 by Scarlet Witch 
    Changes     : renamed form, added branch id, role id and user id, updated medium_get to comunity - added branch id
*/
...
class Communities extends REST_Controller
{
    ...
    public function index_get()
    {
        ...
        if ($role_id == 1 && $role_id !== 2 && $role_id !== 3)  {
            $get_all = $this->communities_model->_get_all($branch_id);          //Admin
        } elseif ($role_id == 2 && $role_id !== 1 &&  $role_id !== 3) {
            $get_all = $this->communities_model->_get_by_user_id($user_id);     //User
        } elseif ($role_id == 3 && $role_id !== 1 && $role_id !== 2) {
            $get_all = $this->communities_model->_get_by_priest($branch_id);    //Priest
        }
    ...
    public function community_get()
    {
        ...
        $get_by_id = $this->communities_model->_get_by_id($branch_id, $id);
