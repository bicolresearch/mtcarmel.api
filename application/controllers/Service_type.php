...
/*
    Filename    : Service_type.php
    Location    : application/controllers/Service_type.php
    Purpose     : Product / Service type controller
    Created     : 09/24/2019 22:26:00 by Spiderman
    Updated     : 
    Changes     : 
*/
...
class Service_type extends REST_Controller
{
    private $group_id;
    private $module_id;
