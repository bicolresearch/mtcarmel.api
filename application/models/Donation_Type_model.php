...
/*
    ...
    Updated     : 08/17/2019 17:45:04 by Scarlet Witch
    Changes     : changed table for all dropdown type into 1 table (dropdown_references) - from donation_schedule_type to dropdown_references 
*/
...
class Donation_type_model extends CI_Model
{
    ...
    public function _get_all()
    {
        $this->db
            ...
            ->join('dropdown_references AS t3', 't3.id = t1.donation_schedule_type_id', 'left') 
